...
/*   Updated: 2022/11/19 16:45:26 by fsariogl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	else if (ft_strcmp(comm.sgl_cmd, "export") == 1)
//	else if (ft_strcmp(comm.sgl_cmd, "unset") == 1)
//	else if (ft_strcmp(comm.sgl_cmd, "env") == 1)
//	else if (ft_strcmp(comm.sgl_cmd, exit) == 1)
	return (0);
}
